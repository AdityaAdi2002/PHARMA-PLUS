        ...
        <form action="/customerlogin" method="post">
            <table class="tab" style=" height: 300px; width: 300px; border-radius: 10px;">
              ...
              <th>${fail}</th>
                ...
                <tr>
                    <th style="font-size: 20px; font-style:normal;text-align: center;">USER LOGIN</th>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <input type="password" name="password" id="password" placeholder="password" style="width: 200px; height: 25px; font-size: 12px; background-color: lightgoldenrodyellow;">
                    </td>
                </tr>
                <tr>
                    <td>
                        <button style="width: 200px; height: 30px; background-color: orange;border-style: none; border-radius: 2px;">Login</button>
                    </td>
                </tr>
            </table>
        </form>
